...
!include "WProbe.nsdinc"
 
Page custom fnc_ProbeWelcomeDialog_Show
...
Section
	...
	DetailPrint "Starting Probe Installation"    
	
	File '/oname=$PluginsDir\WindowsProbeSetup.exe' 'WindowsProbeSetup.exe'
	ExecWait '"$PluginsDir\WindowsProbeSetup.exe" $R0' $0 
	
	DetailPrint "WindowsProbeSetup exit code = $0"	
	Delete "$PluginsDir\WindowsProbeSetup.exe"		
	...
	${If} $R5 != 0
		MessageBox MB_OK "Unable to complete Probe Installation. Error Code: $R5"		
